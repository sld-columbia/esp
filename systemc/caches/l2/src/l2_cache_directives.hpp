...
#define GET_CPU_REQ					\
    ...
    // CACHE_REPORT_TIME(sc_time_stamp(), "Get cpu req.")
#define GET_FLUSH \
    HLS_DEFINE_PROTOCOL("l2-get-flush-protocol"); \
    bookmark_tmp |= BM_GET_FLUSH
    // CACHE_REPORT_TIME(sc_time_stamp(), "Get flush.")
...
#define FLUSH_READ_SET \
    ...
    // CACHE_REPORT_TIME(sc_time_stamp(), "Flush read set.")
#define FLUSH_LOOP \
