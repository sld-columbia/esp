...
public:
    ...
    put_initiator<llc_req_in_t>  llc_dma_req_in_tb;
    ...
    get_initiator<llc_rsp_out_t> llc_dma_rsp_out_tb;
    ...
    void put_dma_req_in(mix_msg_t coh_msg, addr_t addr, line_t line, cache_id_t cache_id, hprot_t hprot,
                        word_offset_t woff, word_offset_t wvalid);
