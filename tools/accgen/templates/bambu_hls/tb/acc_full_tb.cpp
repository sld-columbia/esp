...
// C++ testbench for acc_full_name, used by both `make acc_full_name-exe`
// (native execution) and `make acc_full_name-sim` (bambu --generate-tb RTL
...
int main()
{
    ...
    acc_full_name_core(rd_ctrl, rd_data, wr_ctrl, wr_data /* <<--params-call-->> */);
