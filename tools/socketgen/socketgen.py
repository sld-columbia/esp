...
def write_acc_interface(f, acc, dma_width, datatype, rst, is_vivadohls_if, is_catapulthls_cxx_if, is_catapulthls_sysc_if):
  ...
  if is_catapulthls_cxx_if:
    ...
    f.write("      dma_read_ctrl_data_mode    : out std_logic_vector(" + str(3) + " downto 0);\n")
    ...
    f.write("      dma_write_ctrl_data_mode   : out std_logic_vector(" + str(3) + " downto 0);\n")
...
def write_acc_port_map(f, acc, dma_width, datatype, rst, is_noc_interface, is_vivadohls_if, is_catapulthls_cxx_if, is_catapulthls_sysc_if):
  ...
  if is_vivadohls_if:
    ...
    f.write("      dma_read_ctrl_msg(" + str(70) + " downto " + str(67) + ") => dma_read_ctrl_data_mode,\n")
    ...
    f.write("      dma_write_ctrl_msg(" + str(70) + " downto " + str(67) + ") => dma_write_ctrl_data_mode,\n")
    ...
    f.write("      dma_read_ctrl_data_mode    => dma_read_ctrl_data_mode,\n")
    ...
    f.write("      dma_write_ctrl_data_mode    => dma_write_ctrl_data_mode,\n")
