...
def write_cache_interface(f, cac, is_llc):
  if (is_llc):
    ...
    f.write("      llc_req_in_data_word_mask    : in std_logic_vector(" + str(word_offset_bits**2 - 1) + "  downto 0);\n")
    ...
    f.write("      llc_dma_req_in_data_word_mask    : in std_logic_vector(" + str(word_offset_bits**2 - 1) + "  downto 0);\n")
    ...
    f.write("      llc_rsp_in_data_word_mask    : in std_logic_vector(" + str(word_offset_bits**2 - 1) + "  downto 0);\n")
    ...
    f.write("      llc_rsp_out_data_word_mask   : out std_logic_vector(" + str(word_offset_bits**2 - 1) + "  downto 0);\n")
    ...
    f.write("      llc_dma_rsp_out_data_word_mask   : out std_logic_vector(" + str(word_offset_bits**2 - 1) + "  downto 0);\n")
    ...
    f.write("      llc_fwd_out_data_word_mask   : out std_logic_vector(" + str(word_offset_bits**2 - 1) + "  downto 0);\n")
    ...
    f.write("      l2_fwd_in_data_word_mask  : in std_logic_vector(" + str(word_offset_bits**2 - 1) + "  downto 0);\n")
    ...
    f.write("      l2_rsp_in_data_word_mask  : in std_logic_vector(" + str(word_offset_bits**2 - 1) + "  downto 0);\n")
    ...
    f.write("      l2_req_out_data_word_mask : out std_logic_vector(" + str(word_offset_bits**2 - 1) + "  downto 0);\n")
    ...
    f.write("      l2_rsp_out_data_word_mask : out std_logic_vector(" + str(word_offset_bits**2 - 1) + "  downto 0);\n")
    ...
    f.write("      l2_fwd_out_data_word_mask : out std_logic_vector(" + str(word_offset_bits**2 - 1) + "  downto 0);\n")
