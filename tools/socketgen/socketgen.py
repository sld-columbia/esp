...
def write_acc_interface(f, acc, noc_width, datatype, rst, is_vivadohls_if, is_catapulthls_cxx_if, is_catapulthls_sysc_if):
  ...
  if is_catapulthls_cxx_if:
    ...
    f.write("\n")
    f.write("      dma_read_ctrl_rsc_dat      : out std_logic_vector(" + str(71) + " downto 0);\n")
    f.write("      dma_read_ctrl_rsc_vld      : out std_ulogic;\n")
    f.write("      dma_read_ctrl_rsc_rdy      : in  std_ulogic;\n")
    f.write("\n")
    f.write("      dma_write_ctrl_rsc_dat     : out std_logic_vector(" + str(71) + " downto 0);\n")
    ...
    f.write("\n")
    f.write("      dma_read_ctrl_msg          : out std_logic_vector(" + str(71) + " downto 0);\n")
    f.write("      dma_read_ctrl_val          : out std_ulogic;\n")
    f.write("      dma_read_ctrl_rdy          : in  std_ulogic;\n")
    f.write("\n")
    f.write("      dma_write_ctrl_msg         : out std_logic_vector(" + str(71) + " downto 0);\n")
    ...
    f.write("      dma_read_ctrl_data_user    : out std_logic_vector(" + str(4) + " downto 0);\n")
    ...
    f.write("      dma_write_ctrl_data_user   : out std_logic_vector(" + str(4) + " downto 0);\n")
...
def write_acc_port_map(f, acc, noc_width, datatype, rst, is_noc_interface, is_vivadohls_if, is_catapulthls_cxx_if, is_catapulthls_sysc_if):
  ...
  if is_vivadohls_if:
    ...
    f.write("  ---- CTRL FSM\n")
    f.write("\n")
    f.write("  dma_read_ctrl_data_user    <= dma_read_ctrl_data(100 downto 96);\n")
    ...
    f.write("  dma_write_ctrl_data_user   <= dma_write_ctrl_data(100 downto 96);\n")
    ...
    f.write("\n")
    f.write("      dma_read_ctrl_rsc_dat(71 downto 67) => dma_read_ctrl_data_user,\n")
    ...
    f.write("\n")
    f.write("      dma_write_ctrl_rsc_dat(71 downto 67) => dma_write_ctrl_data_user,\n"),
    f.write("      dma_write_ctrl_rsc_dat(66 downto 64) => dma_write_ctrl_data_size,\n"),
    f.write("      dma_write_ctrl_rsc_dat(63 downto 32) => dma_write_ctrl_data_length,\n")
    f.write("      dma_write_ctrl_rsc_dat(31 downto 0)  => dma_write_ctrl_data_index,\n")
    ...
    f.write("      dma_read_ctrl_msg(71 downto 67) => dma_read_ctrl_data_user,\n")
    ...
    f.write("      dma_write_ctrl_msg(71 downto 67) => dma_write_ctrl_data_user,\n")
    f.write("      dma_write_ctrl_msg(66 downto 64) => dma_write_ctrl_data_size,\n")
    f.write("      dma_write_ctrl_msg(63 downto 32) => dma_write_ctrl_data_length,\n")
    f.write("      dma_write_ctrl_msg(31 downto 0)  => dma_write_ctrl_data_index,\n")
