...
def write_acc_interface(f, acc, noc_width, datatype, rst, is_vivadohls_if, is_catapulthls_cxx_if, is_catapulthls_sysc_if):
  ...
  if is_catapulthls_cxx_if:
    ...
    f.write("      dma_read_ctrl_data_user    : out std_logic_vector(" + str(5) + " downto 0);\n")
    ...
    f.write("      dma_write_ctrl_data_user   : out std_logic_vector(" + str(5) + " downto 0);\n")
...
def write_acc_port_map(f, acc, noc_width, datatype, rst, is_noc_interface, is_vivadohls_if, is_catapulthls_cxx_if, is_catapulthls_sysc_if):
  ...
  if is_vivadohls_if:
    ...
    f.write("\n")
    f.write("      dma_read_ctrl_rsc_dat(72 downto 67) => dma_read_ctrl_data_user,\n")
    ...
    f.write("\n")
    f.write("      dma_write_ctrl_rsc_dat(72 downto 67) => dma_write_ctrl_data_user,\n"),
