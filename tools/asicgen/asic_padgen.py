        ...
        if len(pad_dict["in"]) == 2:
            for i in range(len(pad_dict["in"])):
                if pad_dict["in"][i]["type"] == "V" and in_v_checked == False:
                    ...
                    print(
                        "Error: \"Input pad direction has to have Horizontal and Vertical types\" ")
        else:
        ...
        if len(pad_dict["out"]) == 2:
            for i in range(len(pad_dict["out"])):
                if pad_dict["out"][i]["type"] == "V" and out_v_checked == False:
                    ...
                    print(
                        "Error: \"Output pad direction has to have Horizontal and Vertical types\" ")
        else:
        ...
        if len(pad_dict["io"]) == 2:
            for i in range(len(pad_dict["io"])):
                if pad_dict["io"][i]["type"] == "V" and io_v_checked == False:
                    ...
                    print(
                        "Error: \"Inout pad direction has to have Horizontal and Vertical types\" ")
        else:
            print("Error: \"Inout pad direction has to have two types\" ")

    else:
        print(
            "Error: \"asic_padlist file must have three pads directions - in, out and io\" ")
    ...
    if valid_pads:
        ...
        for idx in range(len(pad_dict["in"])):
            ...
            if os.path.exists(file):
                ...
                print("\"input pad %s\" generated!" %
                      (' '.join(map(str, list(pad_dict["in"][idx].values())))))
        ...
        for idx in range(len(pad_dict["out"])):
            ...
            if os.path.exists(file):
                ...
                print_wrap_pad(file, module, macro_name, pad_dir, pad_type)
                print("\"output pad %s\" generated!" %
                      (' '.join(map(str, list(pad_dict["out"][idx].values())))))
        ...
        for idx in range(len(pad_dict["io"])):
            ...
            if os.path.exists(file):
                ...
                print_wrap_pad(file, module, macro_name, pad_dir, pad_type)
                print("\"inout pad %s\" generated!" %
                      (' '.join(map(str, list(pad_dict["io"][idx].values())))))
