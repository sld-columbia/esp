...
def print_usage():
  print("Usage                    : ./esp_creator.py <dma_width> <tech> <linux_mac> <leon3_stack> <fpga_board>")
  print("")
  print("")
...
class PeripheralFrame(Frame):
  ...
  def __init__(self, soc, top_frame, main_frame):
    ...
    # JTAG
    if soc.TECH == "gf12" or soc.TECH == "gf22":
...
soc = SoC_Config(DMA_WIDTH, TECH, LINUX_MAC, LEON3_STACK, FPGA_BOARD, True)
