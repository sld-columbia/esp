...
ifeq ($(BOARD),terasic-de10-pro-sx)
	@echo " make hps                              : build DE10-Pro SX HPS boot artifacts and DTB."
	@echo " make hps-clean                        : remove generated DE10-Pro SX HPS boot artifacts."
	@echo " make hps-toolchain                    : build a local AArch64 Linux cross compiler for HPS artifacts."
	@echo " make hps-boot                         : clone/build U-Boot plus TF-A and write local boot artifacts."
	@echo " make hps-dtb                          : compile the DE10-Pro SX HPS boot device tree."
endif
