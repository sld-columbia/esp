...
def write_cache_interface(f, cac, is_llc):
  if (is_llc):
    ...
    f.write("      llc_req_in_data_req_id      : in std_logic_vector(2 downto 0);\n")
    ...
    f.write("      llc_rsp_in_data_req_id      : in std_logic_vector(2 downto 0);\n")
    ...
    f.write("      llc_rsp_out_data_invack_cnt : out std_logic_vector(2 downto 0);\n")
    f.write("      llc_rsp_out_data_req_id     : out std_logic_vector(2 downto 0);\n")
    f.write("      llc_rsp_out_data_dest_id    : out std_logic_vector(2 downto 0);\n")
    ...
    f.write("      llc_fwd_out_data_req_id     : out std_logic_vector(2 downto 0);\n")
    f.write("      llc_fwd_out_data_dest_id    : out std_logic_vector(2 downto 0);\n")
