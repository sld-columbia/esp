...
public:
    OperatingPoint(int i, float f, float v, float p, QWidget *parent)
        : id(i)
        , MHz(new QLineEdit(to_string(f).c_str(), parent))
        , MHz_l(new QLabel("MHz", parent))
        , V(new QLineEdit(to_string(v).c_str(), parent))
        , V_l(new QLabel("V", parent))
        , mW(new QLineEdit(to_string(p).c_str(), parent))
        , mW_l(new QLabel("mW", parent))
...
public:
    Power(QWidget *parent, QGridLayout *parent_layout,
