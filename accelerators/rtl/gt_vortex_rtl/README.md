...
```bash
make CONFIGS="-DESP_GT_VORTEX_NUM_CORES=<C> -DESP_GT_VORTEX_NUM_WARPS=<W> -DESP_GT_VORTEX_NUM_THREADS=<T>" software
make CONFIGS="-DESP_GT_VORTEX_NUM_CORES=<C> -DESP_GT_VORTEX_NUM_WARPS=<W> -DESP_GT_VORTEX_NUM_THREADS=<T>" tests
```
