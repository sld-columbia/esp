...
HLS_MAP_TO_MEMORY(ROWS0, "plm_16_1w1r")
#define HLS_MAP_ROWS1 \
HLS_MAP_TO_MEMORY(ROWS1, "plm_16_1w1r")
#define HLS_MAP_COLS \
HLS_MAP_TO_MEMORY(COLS, "plm_256_1w1r")
#define HLS_MAP_VALS0 \
HLS_MAP_TO_MEMORY(VALS0, "plm_256_1w1r")
#define HLS_MAP_VALS1 \
HLS_MAP_TO_MEMORY(VALS1, "plm_256_1w1r")
#define HLS_MAP_VECT0 \
HLS_MAP_TO_MEMORY(VECT0, "plm_256_1w1r")
#define HLS_MAP_VECT1 \
HLS_MAP_TO_MEMORY(VECT1, "plm_256_1w1r")
#define HLS_MAP_OUT0 \
HLS_MAP_TO_MEMORY(OUT0, "plm_16_1w1r")
#define HLS_MAP_OUT1 \
HLS_MAP_TO_MEMORY(OUT1, "plm_16_1w1r")
...
#define HLS_LOAD_COLS_PLM_WRITE						\
	...
	HLS_BREAK_ARRAY_DEPENDENCY(COLS)
