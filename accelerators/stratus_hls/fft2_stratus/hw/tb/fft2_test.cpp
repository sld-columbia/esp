...
void fft2_bit_reverse(float *w, unsigned int offset, unsigned int n,
                      unsigned int bits) {
...
void fft2_do_shift(float *A0, unsigned int offset, unsigned int num_samples,
                   unsigned int bits) {
...
int fft2_comp(float *data, unsigned nffts, unsigned int n, unsigned int logn,
