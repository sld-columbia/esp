...
static int __init fft2_init(void) { return esp_driver_register(&fft2_driver); }

static void __exit fft2_exit(void) { esp_driver_unregister(&fft2_driver); }

module_init(fft2_init) module_exit(fft2_exit)
