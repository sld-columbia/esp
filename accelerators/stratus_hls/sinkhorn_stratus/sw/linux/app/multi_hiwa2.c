...
static void init_parameters() {
  ...
  out_len_svd = out_words_adj_svd * (2);
...
int main(int argc, char **argv) {
  ...
  ((struct sinkhorn_access *)cfg_multi[1].esp_desc)->gamma =
      float_to_fixed32(gamma_float, 11);
  ((struct sinkhorn_access *)cfg_multi[2].esp_desc)->gamma =
      float_to_fixed32(gamma_float, 11);
  ((struct sinkhorn_access *)cfg_multi[3].esp_desc)->gamma =
      float_to_fixed32(gamma_float, 11);
  ((struct sinkhorn_access *)cfg_multi[4].esp_desc)->gamma =
      float_to_fixed32(gamma_float, 11);
  ...
  ((struct svd_access *)cfg_multi[0].esp_desc)->p2p_iter = 2;
  ...
  printf("\n====== 2x%s -> %s %d Iterations ======\n\n", cfg_multi[1].devname,
         cfg_multi[0].devname, N);

  // Configure SVD
  ((struct svd_access *)cfg_multi[0].esp_desc)->p2p_out = 1;
  ((struct svd_access *)cfg_multi[0].esp_desc)->p2p_in = 1;
  ((struct svd_access *)cfg_multi[0].esp_desc)->p2p_iter = N * 2;
  ((struct svd_access *)cfg_multi[0].esp_desc)->load_state = 0;
  ((struct svd_access *)cfg_multi[0].esp_desc)->esp.p2p_store = 1;
  ((struct svd_access *)cfg_multi[0].esp_desc)->esp.p2p_nsrcs = 2;
  //((struct svd_access*) cfg_multi[0].esp_desc)->esp.p2p_srcs = {Default is all
  //sinkhorns};
  ...
  printf("\n Run Sinkhornss->SVD->Sinkhornss (%d iterations) \n", N);
  esp_run(cfg_multi, 3);
  ...
  // strcpy(((struct svd_access*) cfg_multi[0].esp_desc)->esp.p2p_srcs[0],
  // "sinkhorn.0"); strcpy(cfg_multi[1].devname, "sinkhorn.0");
  ...
  cfg_multi[3].hw_buf = buf2;
  cfg_multi[4].hw_buf = buf3;
  printf("\nRun 2 Sinkhorns in parallel and store data in memory\n");
  esp_run(&cfg_multi[1], 2);
  ...
  // esp_run(&cfg_multi[1], 1);
  // strcpy(cfg_multi[1].devname, "sinkhorn.1");
  // cfg_multi[1].hw_buf = buf1;
  ...
  printf("\nResults from HiWA.0:\n");
  errors0 = validate_final(&buf_svd0[out_offset_svd], &buf0[out_offset], finalR,
                           finalQ);
  printf("\nResults from HiWA.1:\n");
  errors1 = validate_final(&buf_svd0[out_offset_svd + out_words_adj_svd],
                           &buf1[out_offset], finalR, finalQ);
  /* printf("\nResults from HiWA.2:\n"); */
  /* errors2 = validate_final(&buf_svd0[out_offset_svd+2*out_words_adj_svd],
   * &buf2[out_offset], finalR, finalQ); */
  /* printf("\nResults from HiWA.3:\n"); */
  /* errors3 = validate_final(&buf_svd0[out_offset_svd+3*out_words_adj_svd],
   * &buf3[out_offset], finalR, finalQ); */
  ...
  ((struct svd_access *)cfg_multi[0].esp_desc)->p2p_out = 1;
  ((struct svd_access *)cfg_multi[0].esp_desc)->p2p_in = 0;
  ((struct svd_access *)cfg_multi[0].esp_desc)->p2p_iter = 3;
  ((struct svd_access *)cfg_multi[0].esp_desc)->load_state = 0;
  ((struct svd_access *)cfg_multi[0].esp_desc)->esp.p2p_store = 1;
  ((struct svd_access *)cfg_multi[0].esp_desc)->esp.p2p_nsrcs = 0;
  ...
  ((struct svd_access *)cfg_multi[0].esp_desc)->p2p_out = 1;
  ((struct svd_access *)cfg_multi[0].esp_desc)->p2p_in = 1;
  ((struct svd_access *)cfg_multi[0].esp_desc)->p2p_iter = N * 3;
  ((struct svd_access *)cfg_multi[0].esp_desc)->load_state = 0;
  ((struct svd_access *)cfg_multi[0].esp_desc)->esp.p2p_store = 1;
  ((struct svd_access *)cfg_multi[0].esp_desc)->esp.p2p_nsrcs = 3;
  //((struct svd_access*) cfg_multi[0].esp_desc)->esp.p2p_srcs = {Default is all
  //sinkhorns};
  ...
  printf("\n Run Sinkhors->SVD->Sinkhorns (%d iterations) \n", N);
  esp_run(cfg_multi, 4);
