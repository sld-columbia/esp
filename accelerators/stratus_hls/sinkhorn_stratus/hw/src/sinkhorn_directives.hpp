...
#define __SINKHORN_DIRECTIVES_HPP__
    ...
    #define HLS_MAP_inputx_plm(_mem) HLS_MAP_TO_MEMORY(_mem, PLM_IN_X_NAME)

    #define HLS_MAP_inputy_plm(_mem) HLS_MAP_TO_MEMORY(_mem, PLM_IN_Y_NAME)

    #define HLS_MAP_output_plm(_mem) HLS_MAP_TO_MEMORY(_mem, PLM_OUT_NAME)

    #define HLS_MAP_output2_plm(_mem) HLS_MAP_TO_MEMORY(_mem, PLM_OUT2_NAME)

    #define HLS_MAP_intermed_plm(_mem) HLS_MAP_TO_MEMORY(_mem, "sinkhorn_intermed_plm")

    #define HLS_MAP_intermed2_plm(_mem) HLS_MAP_TO_MEMORY(_mem, "sinkhorn_intermed2_plm")
