...
/* User-defined code */
static void init_parameters(int test, int32_t do_relu, int32_t transpose,
                            int32_t ninputs, int32_t d3, int32_t d2, int32_t d1,
                            unsigned *in_len, unsigned *in1_len,
                            unsigned *out_len, unsigned *in_size,
...
static void sw_run(int32_t do_relu, int32_t transpose, int32_t ninputs,
                   int32_t d3, int32_t d2, int32_t d1, native_t *in1,
                   native_t *in2, native_t *out) {
  int i, j, k, l;
...
int main(int argc, char **argv) {
  ...
  for (test = start_test - 1; test < n_tests + start_test - 1; ++test) {
    ...
    init_parameters(test, do_relu[test], transpose[test], ninputs[test],
                    d3[test], d2[test], d1[test], &in_len, &in1_len, &out_len,
    ...
    sw_run(do_relu[test], transpose[test], ninputs[test], d3[test], d2[test],
           d1[test], sw_buf, &sw_buf[in1_len], &sw_buf[in_len]);
