...
int main(int argc, char **argv)
{
    ...
    for (test = start_test - 1; test < n_tests + start_test - 1; ++test) {
        ...
        init_parameters(test, do_relu[test], transpose[test], ninputs[test], d3[test], d2[test], d1[test], &in_len,
                        &in1_len, &out_len, &in_size, &out_size, &size);
        ...
        sw_run(do_relu[test], transpose[test], ninputs[test], d3[test], d2[test], d1[test], sw_buf, &sw_buf[in1_len],
               &sw_buf[in_len]);
