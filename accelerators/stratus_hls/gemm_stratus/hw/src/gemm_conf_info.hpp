...
class conf_info_t {
  ...
  public:
    ...
    conf_info_t() :
        ninputs(0), d1(0), d2(0), d3(0), ld_offset1(0), ld_offset2(0), st_offset(0), do_relu(0),
        transpose(0)
    {
    }
    ...
    inline bool operator==(const conf_info_t &rhs) const
    {
        return (rhs.ninputs == ninputs) && (rhs.d1 == d1) && (rhs.d2 == d2) && (rhs.d3 == d3) &&
            (rhs.ld_offset1 == ld_offset1) && (rhs.ld_offset2 == ld_offset2) &&
            (rhs.st_offset == st_offset) && (rhs.do_relu == do_relu) &&
