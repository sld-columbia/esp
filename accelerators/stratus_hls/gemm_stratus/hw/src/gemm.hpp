...
class gemm : public esp_accelerator_3P<DMA_WIDTH>
{
  public:
    ...
    inline void calculate_config(uint24_t ninputs, uint24_t matrix_d1, uint24_t matrix_d2, uint24_t matrix_d3,
    ...
    inline void sync_compute_store(uint16_t &count, uint16_t loaded_rows, uint8_t load_cfg, uint16_t loadable_rows,
                                   bool &pingpong);
