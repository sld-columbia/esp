...
create_double_matrix_t(double_matrix_t **matrix, size_t *dims, size_t dim) {
  unsigned i, size = 1;
...
store_double_matrix_t(double_matrix_t *matrix, const char *file) {
...
__attribute__((unused)) static int
load_double_matrix_t(double_matrix_t **matrix, const char *file) {
  unsigned int i, size = 1;
...
__attribute__((unused)) static void
free_double_matrix_t(double_matrix_t **matrix) {
  free((*matrix)->data);
  free((*matrix)->dims);
  free(*matrix);
}
