...
int system_t::validate()
{
    ...
    //validate layer
    validate_hw_conv(l_n,hw_output,cnn->layer_sets[l_n]->node.x,layer_out_rows,layer_out_cols,out_pad_h,out_ch,pool_out,cnn_out_size);
