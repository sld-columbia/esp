...
void system_t::config_proc()
{
    ...
    load_memory();
    {
        ...
        /* <<--params-->> */
        config.rd_sp_offset = rd_sp_offset;
        config.rd_wr_enable = rd_wr_enable;
        config.wr_size = wr_size;
        config.wr_sp_offset = wr_sp_offset;
        config.rd_size = rd_size;
        config.dst_offset = dst_offset;
        config.src_offset = src_offset;
    ...
    // Compute
    {
        ...
        ESP_REPORT_TIME(begin_time, "BEGIN - sensor_dma");
        ...
        ESP_REPORT_TIME(end_time, "END - sensor_dma");
...
#else
    in_words_adj = round_up(src_offset, DMA_WORD_PER_BEAT);
    out_words_adj = round_up(src_offset, DMA_WORD_PER_BEAT);
#endif
