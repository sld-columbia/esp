...
#ifndef __FPDATA_HPP__
#define __FPDATA_HPP__
...
const unsigned int FPDATA_WL = 32; // 32

const unsigned int FPDATA_PL = 21; // 16

const unsigned int FPDATA_IL = 11; // 16
