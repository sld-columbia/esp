...
static int __init conv2d_init(void) { return esp_driver_register(&conv2d_driver); }

static void __exit conv2d_exit(void) { esp_driver_unregister(&conv2d_driver); }

module_init(conv2d_init) module_exit(conv2d_exit)
