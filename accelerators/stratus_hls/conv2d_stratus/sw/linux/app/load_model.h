...
/* void load_model(float* test_1,float* w_conv1,float* w_conv2,float*w_conv3,float*w_conv4,float* bias1,float*bias2,float* bias3,float* bias4,float* bias5,float* bias6,float*fc1,float*fc2) */
void load_model(float* test_1,float** w_conv,float** bias_conv,float** w_fc,float** bias_fc)
{

	FILE* inFile0=fopen("dwarf_model1/test_1.bin","rb");
	...
	FILE* inFile1 =fopen("dwarf_model1/conv1.bin","rb");
	...
	FILE* inFile2 =fopen("dwarf_model1/conv2.bin","rb");
	...
	FILE* inFile3 =fopen("dwarf_model1/conv3.bin","rb");
	...
	FILE* inFile4 =fopen("dwarf_model1/conv4.bin","rb");
	...
	FILE* inFile5 =fopen("dwarf_model1/bias1.bin","rb");
	...
	FILE* inFile6 =fopen("dwarf_model1/bias2.bin","rb");
	...
	FILE* inFile7 =fopen("dwarf_model1/bias3.bin","rb");
	...
	FILE* inFile_7 =fopen("dwarf_model1/bias4.bin","rb");
	...
	FILE* inFile_8 =fopen("dwarf_model1/bias5.bin","rb");
	...
	FILE* inFile_9 =fopen("dwarf_model1/bias6.bin","rb");
	...
	FILE* inFile8 =fopen("dwarf_model1/fc1.bin","rb");
	...
	FILE* inFile9 =fopen("dwarf_model1/fc2.bin","rb");
