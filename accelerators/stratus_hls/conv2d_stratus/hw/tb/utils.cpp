...
void print_image(const char *name, float *image, const int batch_size, const int channels, const int height,
...
void print_weights(const char *name, float *weights, const int filters, const int channels, const int height,
                   const int width, const bool fpdata)
{
