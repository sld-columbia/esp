...
class conf_info_t {
  public:
    ...
    conf_info_t(
        /* <<--ctor-args-->> */
        int32_t n_channels, int32_t n_filters, int32_t filter_dim, int32_t stride,
        int32_t is_padded, int32_t feature_map_height, int32_t feature_map_width, int32_t do_relu,
        int32_t pool_type, int32_t batch_size)
    {
        /* <<--ctor-custom-->> */
