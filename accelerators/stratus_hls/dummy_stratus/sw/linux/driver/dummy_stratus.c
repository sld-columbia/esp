...
static int __init dummy_init(void) { return esp_driver_register(&dummy_driver); }

static void __exit dummy_exit(void) { esp_driver_unregister(&dummy_driver); }
