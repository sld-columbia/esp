...
public:
        ...
        : esp_system<DMA_WIDTH, MEM_SIZE>(name)
    {
        // ACC
#ifdef CADENCE
        acc = new cholesky_small_wrapper("cholesky_small_wrapper");
#else
        acc = new cholesky_small("cholesky_small_wrapper");
#endif
        // Binding ACC
        acc->clk(clk);
        acc->rst(acc_rst);
