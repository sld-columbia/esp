...
void init_buffer(float *in, float *gold, const char *inputFile, const char *goldFile, int32_t batch_size_x,
                 int32_t num_batch_x, int32_t batch_size_k, int32_t num_batch_k)
{
