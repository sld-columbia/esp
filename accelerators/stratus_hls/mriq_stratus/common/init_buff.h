...
void init_buffer(float *in, float *gold, const char *inputFile,
                 const char *goldFile, int32_t batch_size_x,
  ...
  inputData(inputFile, &numK_bm, &numX_bm, &kx, &ky, &kz, &x, &y, &z, &phiR,
            &phiI);
