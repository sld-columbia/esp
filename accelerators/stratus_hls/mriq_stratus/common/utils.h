...
void init_parameters(int32_t batch_size_x, int32_t num_batch_x, int32_t batch_size_k, int32_t num_batch_k,
                     unsigned *in_words_adj, unsigned *out_words_adj, unsigned *in_len, unsigned *out_len,
                     unsigned *in_size, unsigned *out_size, unsigned *out_offset, unsigned *mem_size,
                     unsigned dma_word_per_beat)
{
