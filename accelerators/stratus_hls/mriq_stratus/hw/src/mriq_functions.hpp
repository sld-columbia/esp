...
void mriq::ComputeQ(FPDATA_S x, FPDATA_S y, FPDATA_S z, uint16_t batch_size_k, bool pingpong_k, FPDATA_S *sin_table,
                    FPDATA_L *Qr, FPDATA_L *Qi)
{
    ...
    #elif (PARAL == 16)
        Qracc += Qracc_p[0] + Qracc_p[1] + Qracc_p[2] + Qracc_p[3] + Qracc_p[4] + Qracc_p[5] + Qracc_p[6] + Qracc_p[7] +
                 Qracc_p[8] + Qracc_p[9] + Qracc_p[10] + Qracc_p[11] + Qracc_p[12] + Qracc_p[13] + Qracc_p[14] +
                 Qracc_p[15];
        Qiacc += Qiacc_p[0] + Qiacc_p[1] + Qiacc_p[2] + Qiacc_p[3] + Qiacc_p[4] + Qiacc_p[5] + Qiacc_p[6] + Qiacc_p[7] +
                 Qiacc_p[8] + Qiacc_p[9] + Qiacc_p[10] + Qiacc_p[11] + Qiacc_p[12] + Qiacc_p[13] + Qiacc_p[14] +
                 Qiacc_p[15];
    #endif
...
FPDATA_S mriq::mySinf(FPDATA_L angle, FPDATA_S *sin_table)
{
    ...
    angle_within_2pi =
        angle - PI * 2 * floor(cynw_fixed<FPDATA_L_WL, FPDATA_L_IL, SC_TRN, SC_WRAP, 1>(angle * REC_PI * 0.5));
    ...
    switch (q) {
        case 0:
            radian = angle_within_2pi;
            break;
        case 1:
            radian = PI - angle_within_2pi;
            break;
        case 2:
            radian = angle_within_2pi - PI;
            break;
        case 3:
            radian = PI * 2 - angle_within_2pi;
            break;
        default:
            radian = angle_within_2pi;
            break;
