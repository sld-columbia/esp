...
void mriq::load_input() {
  ...
  // Load
  {
    ...
    // for A0, dma_length_k = batch_size_k/DMA_WORD_PER_BEAT, batch_size_k =
    // numK

    dma_read<FPDATA_S_WORD>(plm_kx, dma_index, dma_length_k);
    dma_index += dma_length_k;
    dma_read<FPDATA_S_WORD>(plm_ky, dma_index, dma_length_k);
    dma_index += dma_length_k;
    dma_read<FPDATA_S_WORD>(plm_kz, dma_index, dma_length_k);
    dma_index += dma_length_k;
    dma_read<FPDATA_S_WORD>(plm_phiR, dma_index, dma_length_k);
    dma_index += dma_length_k;
    dma_read<FPDATA_S_WORD>(plm_phiI, dma_index, dma_length_k);
    dma_index += dma_length_k;
    ...
    for (int l = 0; l < num_batch_x; l++) {
      ...
      if (pingpong_x) {
        dma_read<FPDATA_S_WORD>(plm_x_ping, dma_index, dma_length_x);
        dma_index += dma_length_x;
        dma_read<FPDATA_S_WORD>(plm_y_ping, dma_index, dma_length_x);
        dma_index += dma_length_x;
        dma_read<FPDATA_S_WORD>(plm_z_ping, dma_index, dma_length_x);
        dma_index += dma_length_x;
      } else {
        dma_read<FPDATA_S_WORD>(plm_x_pong, dma_index, dma_length_x);
        dma_index += dma_length_x;
        dma_read<FPDATA_S_WORD>(plm_y_pong, dma_index, dma_length_x);
        dma_index += dma_length_x;
        dma_read<FPDATA_S_WORD>(plm_z_pong, dma_index, dma_length_x);
        dma_index += dma_length_x;
      }
    ...
    int32_t dma_index_x =
        (5 * batch_size_k * num_batch_k) >> (DMA_WORD_PER_BEAT - 1);
    ...
    for (int l = 0; l < total_loading; l++) {
      // in if statement, counter_x == XXX, this number is the initialized
      // value.

      if (counter_x == counter_x_ini && pingpong_x == true) {

        dma_read<FPDATA_S_WORD>(plm_x_ping, dma_index_x, dma_length_x);
        dma_index_x += dma_length_x;
        dma_read<FPDATA_S_WORD>(plm_y_ping, dma_index_x, dma_length_x);
        dma_index_x += dma_length_x;
        dma_read<FPDATA_S_WORD>(plm_z_ping, dma_index_x, dma_length_x);
        dma_index_x += dma_length_x;
        ...
        dma_read<FPDATA_S_WORD>(plm_x_pong, dma_index_x, dma_length_x);
        dma_index_x += dma_length_x;
        dma_read<FPDATA_S_WORD>(plm_y_pong, dma_index_x, dma_length_x);
        dma_index_x += dma_length_x;
        dma_read<FPDATA_S_WORD>(plm_z_pong, dma_index_x, dma_length_x);
        dma_index_x += dma_length_x;
      ...
      if (pingpong_k) {
        // HLS_PROTO("load ping");
        dma_read<FPDATA_S_WORD>(plm_kx_ping, dma_index, dma_length_k);
        dma_index += dma_length_k;
        dma_read<FPDATA_S_WORD>(plm_ky_ping, dma_index, dma_length_k);
        dma_index += dma_length_k;
        dma_read<FPDATA_S_WORD>(plm_kz_ping, dma_index, dma_length_k);
        dma_index += dma_length_k;
        dma_read<FPDATA_S_WORD>(plm_phiR_ping, dma_index, dma_length_k);
        dma_index += dma_length_k;
        dma_read<FPDATA_S_WORD>(plm_phiI_ping, dma_index, dma_length_k);
        dma_index += dma_length_k;
        ...
        dma_read<FPDATA_S_WORD>(plm_kx_pong, dma_index, dma_length_k);
        dma_index += dma_length_k;
        dma_read<FPDATA_S_WORD>(plm_ky_pong, dma_index, dma_length_k);
        dma_index += dma_length_k;
        dma_read<FPDATA_S_WORD>(plm_kz_pong, dma_index, dma_length_k);
        dma_index += dma_length_k;
        dma_read<FPDATA_S_WORD>(plm_phiR_pong, dma_index, dma_length_k);
        dma_index += dma_length_k;
        dma_read<FPDATA_S_WORD>(plm_phiI_pong, dma_index, dma_length_k);
        dma_index += dma_length_k;
...
void mriq::store_output() {
  ...
  // Store
  {
    ...
    const uint32_t store_offset = round_up(3 * batch_size_x * num_batch_x +
                                               5 * batch_size_k * num_batch_k,
                                           DMA_WORD_PER_BEAT);
    ...
    for (int i = 0; i < num_batch_x; i++) {
      ...
      if (pingpong_x) {
        dma_write<FPDATA_L_WORD>(plm_Qr_ping, dma_index, dma_length_x);
        dma_index += dma_length_x;
        dma_write<FPDATA_L_WORD>(plm_Qi_ping, dma_index, dma_length_x);
        dma_index += dma_length_x;
      } else {
        dma_write<FPDATA_L_WORD>(plm_Qr_pong, dma_index, dma_length_x);
        dma_index += dma_length_x;
        dma_write<FPDATA_L_WORD>(plm_Qi_pong, dma_index, dma_length_x);
        dma_index += dma_length_x;
      }
      pingpong_x = !pingpong_x;
    }
