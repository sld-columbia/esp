...
static void init_buf(token_t *in, float *in_fp, float *gold, const char *inputFile, const char *goldFile)
{
    ...
    init_buffer(in_fp, gold, be_inputFile, be_goldFile, batch_size_x, num_batch_x, batch_size_k, num_batch_k);

#else

    init_buffer(in_fp, gold, inputFile, goldFile, batch_size_x, num_batch_x, batch_size_k, num_batch_k);
#endif
...
int main(int argc, char **argv)
{
    ...
    init_parameters(batch_size_x, num_batch_x, batch_size_k, num_batch_k, &in_words_adj, &out_words_adj, &in_len,
                    &out_len, &in_size, &out_size, &out_offset, &mem_size, DMA_WORD_PER_BEAT(sizeof(token_t)));
    ...
    if (run_sw) {
        ...
        sw_exec(out_sw, in_fp, batch_size_x, num_batch_x, batch_size_k, num_batch_k);
