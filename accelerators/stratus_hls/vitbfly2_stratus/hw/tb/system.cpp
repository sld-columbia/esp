...
void system_t::load_memory() {
  ...
  //  ==========================================  ^
  //  |  in/out mm0 (uint 8) [64]              |  | in/out  (64 bytes)
  //  {d_metric0}
  //  ==========================================  v
  //  ==========================================  ^
  //  |  in/out mm1 (uint 8) [64]              |  | in/out  (64 bytes)
  //  {d_metric1}
  //  ==========================================  v
  //  ==========================================  ^
  ...
  //  ==========================================  v
  //  ==========================================  ^
  //  |  input symbols (uint 8) [64]           |  | input symbols (64 bytes)
  //  {depunctured}
  //  ==========================================  v
...
int system_t::validate() {
  ...
  for (uint32_t j = 0; j < n_membytes; j += WORDS_PER_DMA) {
    for (uint8_t k = 0; k < WORDS_PER_DMA; k++)
      if (mem[mem_j].range(((k + 1) << 3) - 1, (k << 3)).to_int() !=
          imgGold[j + k]) {
