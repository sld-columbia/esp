...
static bool synth_xfer_input_ok(struct esp_device *esp, void *arg) { return true; }
...
static int __init synth_init(void) { return esp_driver_register(&synth_driver); }

static void __exit synth_exit(void) { esp_driver_unregister(&synth_driver); }

module_init(synth_init) module_exit(synth_exit)
