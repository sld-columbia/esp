...
static bool adder_xfer_input_ok(struct esp_device *esp, void *arg) { return true; }
...
static int __init adder_init(void) { return esp_driver_register(&adder_driver); }

static void __exit adder_exit(void) { esp_driver_unregister(&adder_driver); }

module_init(adder_init) module_exit(adder_exit)
