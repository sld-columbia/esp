...
void top(dma_word_t *out, dma_word_t *in1,
         /* <<--params-->> */
         const unsigned conf_info_q, const unsigned conf_info_p, const unsigned conf_info_m,
         const unsigned conf_info_p2p_out, const unsigned conf_info_p2p_in,
         const unsigned conf_info_p2p_iter, const unsigned conf_info_load_state,
         dma_info_t &load_ctrl, dma_info_t &store_ctrl);

void compute(word_t Q[P_MAX][Q_MAX], word_t X[P_MAX][M_MAX], word_t Y[Q_MAX][M_MAX],
             word_t T[M_MAX][M_MAX], word_t &P, const unsigned q, const unsigned p,
             const unsigned m, const unsigned p2p_out, const unsigned load_state, unsigned &b,
             const unsigned p2p_iter, word_t _outbuff[SIZE_OUT_CHUNK_DATA]);

void load(word_t Q[P_MAX][Q_MAX], word_t X[P_MAX][M_MAX], word_t Y[Q_MAX][M_MAX],
          word_t T[M_MAX][M_MAX], word_t &P, dma_word_t *in1, const unsigned q, const unsigned p,
          const unsigned m, const unsigned p2p_in, const unsigned b, const unsigned load_state,
          dma_info_t &load_ctrl);

void store(word_t _outbuff[SIZE_OUT_CHUNK_DATA], dma_word_t *out, const unsigned q,
           const unsigned p, const unsigned m, const unsigned p2p_out, const unsigned b,
           const unsigned load_state, dma_info_t &store_ctrl);

struct TRAITS_SVD : hls::svd_traits<M_MAX, M_MAX, float, float> {
...
struct TRAITS_C :
    hls::matrix_multiply_traits<hls::Transpose, hls::Transpose, Q_MAX, M_MAX, P_MAX, Q_MAX, word_t,
                                word_t> {
...
struct TRAITS_A :
    hls::matrix_multiply_traits<hls::NoTranspose, hls::NoTranspose, M_MAX, P_MAX, P_MAX, M_MAX,
                                word_t, word_t> {
    static const int ARCH = 2;
...
struct TRAITS_A_F :
    hls::matrix_multiply_traits<hls::NoTranspose, hls::ConjugateTranspose, M_MAX, M_MAX, M_MAX,
                                M_MAX, float, float> {
...
struct TRAITS_X_SINK :
    hls::matrix_multiply_traits<hls::NoTranspose, hls::Transpose, M_MAX, M_MAX, P_MAX, M_MAX,
                                word_t, word_t> {
    static const int ARCH = 2;
