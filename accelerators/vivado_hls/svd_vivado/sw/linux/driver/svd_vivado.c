...
static int __init svd_init(void) { return esp_driver_register(&svd_driver); }

static void __exit svd_exit(void) { esp_driver_unregister(&svd_driver); }

module_init(svd_init) module_exit(svd_exit)
