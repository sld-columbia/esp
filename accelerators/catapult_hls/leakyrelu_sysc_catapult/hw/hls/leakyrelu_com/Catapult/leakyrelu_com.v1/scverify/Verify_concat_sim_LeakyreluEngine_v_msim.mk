# ----------------------------------------------------------------------------
# Concat concat_sim_LeakyreluEngine Verilog
#
...
# Generated date: Thu May 08 19:13:32 EDT 2025
#
# ----------------------------------------------------------------------------
# ===================================================
...
export STAGE
ifeq "$(NETLIST_LEAF)" ""
NETLIST_LEAF           = concat_sim_LeakyreluEngine
endif
export NETLIST_LEAF
ifeq "$(SIMTOOL)" ""
SIMTOOL                = msim
...
ifeq ($(GATE_VLOG_DEP),)
GATE_VLOG_DEP = ./concat_sim_LeakyreluEngine.v/concat_sim_LeakyreluEngine.v.vts
endif
endif
VHDL_SRC +=  $(GATE_VHDL_DEP) 
VLOG_SRC +=  $(GATE_VLOG_DEP) ./scverify/ccs_wrapper_LeakyreluEngine.v/ccs_wrapper_LeakyreluEngine.v.vts
else
VHDL_SRC += 
VLOG_SRC += ./concat_sim_LeakyreluEngine.v/concat_sim_LeakyreluEngine.v.vts ./scverify/ccs_wrapper_LeakyreluEngine.v/ccs_wrapper_LeakyreluEngine.v.vts
endif
...
$(TARGET)/concat_sim_LeakyreluEngine.v.vts: ./concat_sim_LeakyreluEngine.v
...
$(TARGET)/concat_sim_LeakyreluEngine.v.vts: HDL_LIB=work
ifeq ($(STAGE),gate)
ifneq ($(GATE_VHDL_DEP),)
...
$(TARGET)/concat_sim_LeakyreluEngine.v.vts: VLOG_F_OPTS=
$(TARGET)/ccs_wrapper_LeakyreluEngine.v.vts: NCVLOG_F_OPTS=
$(TARGET)/concat_sim_LeakyreluEngine.v.vts: NCVLOG_F_OPTS=
$(TARGET)/ccs_wrapper_LeakyreluEngine.v.vts: VCS_F_OPTS=
$(TARGET)/concat_sim_LeakyreluEngine.v.vts: VCS_F_OPTS=
# 
# Specify top design unit for HDL source
$(TARGET)/ccs_wrapper_LeakyreluEngine.v.vts: DUT_E=ccs_wrapper
$(TARGET)/concat_sim_LeakyreluEngine.v.vts: DUT_E=LeakyreluEngine
