...
//  
//  Running on Linux gtombesi@corsica:21800 3.10.0-1160.102.1.el7.x86_64 x86_64 aol
//  
...
solution file add ../../inc/leakyrelu_ctrl.h -type CHEADER
...
go new
solution design set LeakyreluController -top
