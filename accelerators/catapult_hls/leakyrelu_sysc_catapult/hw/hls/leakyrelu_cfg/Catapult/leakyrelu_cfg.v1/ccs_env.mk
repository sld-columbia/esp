ifeq "$(CXX_HOME)" ""
CXX_HOME                                            := /opt/Catapult_2025/Mgc_home/pkgs/dcs_gcc/usr
export CXX_HOME
endif
ifeq "$(CXX_TYPE)" ""
CXX_TYPE                                            := gcc
...
ifeq "$(OSCI_AC_INT_VRA_FILTER_VARS)" ""
OSCI_AC_INT_VRA_FILTER_VARS                         := false
export OSCI_AC_INT_VRA_FILTER_VARS
endif
ifeq "$(OSCI_AC_FIXED_VRA_FILTER_VARS)" ""
OSCI_AC_FIXED_VRA_FILTER_VARS                       := false
export OSCI_AC_FIXED_VRA_FILTER_VARS
endif
...
Valgrind_VALGRIND                                   := /usr/bin/valgrind
...
ifeq "$(CDesignChecker_CACHE_MODE)" ""
CDesignChecker_CACHE_MODE                           := on
export CDesignChecker_CACHE_MODE
endif
