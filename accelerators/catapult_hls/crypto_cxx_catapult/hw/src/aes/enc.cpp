...
AES_ENCRYPT_L_1:
    for (i = 0; i < 5; i += 1)
    {
        ...
        t0 = Te0[__range(s0, 31, 24)] ^
             Te1[__range(s1, 23, 16)] ^
             Te2[__range(s2, 15,  8)] ^
             Te3[__range(s3,  7,  0)] ^ ekey[j + 4];
        t1 = Te0[__range(s1, 31, 24)] ^
             Te1[__range(s2, 23, 16)] ^
             Te2[__range(s3, 15,  8)] ^
             Te3[__range(s0,  7,  0)] ^ ekey[j + 5];
        t2 = Te0[__range(s2, 31, 24)] ^
             Te1[__range(s3, 23, 16)] ^
             Te2[__range(s0, 15,  8)] ^
             Te3[__range(s1,  7,  0)] ^ ekey[j + 6];
        t3 = Te0[__range(s3, 31, 24)] ^
             Te1[__range(s0, 23, 16)] ^
             Te2[__range(s1, 15,  8)] ^
             Te3[__range(s2,  7,  0)] ^ ekey[j + 7];

        s0 = Te0[__range(t0, 31, 24)] ^
             Te1[__range(t1, 23, 16)] ^
             Te2[__range(t2, 15,  8)] ^
             Te3[__range(t3,  7,  0)] ^ ekey[j + 8];
        s1 = Te0[__range(t1, 31, 24)] ^
             Te1[__range(t2, 23, 16)] ^
             Te2[__range(t3, 15,  8)] ^
             Te3[__range(t0,  7,  0)] ^ ekey[j + 9];
        s2 = Te0[__range(t2, 31, 24)] ^
             Te1[__range(t3, 23, 16)] ^
             Te2[__range(t0, 15,  8)] ^
             Te3[__range(t1,  7,  0)] ^ ekey[j + 10];
        s3 = Te0[__range(t3, 31, 24)] ^
             Te1[__range(t0, 23, 16)] ^
             Te2[__range(t1, 15,  8)] ^
    ...
    s0 = (Te2[__range(t0, 31, 24)] & 0xff000000) ^
         (Te3[__range(t1, 23, 16)] & 0x00ff0000) ^
         (Te0[__range(t2, 15,  8)] & 0x0000ff00) ^
         (Te1[__range(t3,  7,  0)] & 0x000000ff) ^ ekey[j + 0];
    s1 = (Te2[__range(t1, 31, 24)] & 0xff000000) ^
         (Te3[__range(t2, 23, 16)] & 0x00ff0000) ^
         (Te0[__range(t3, 15,  8)] & 0x0000ff00) ^
         (Te1[__range(t0,  7,  0)] & 0x000000ff) ^ ekey[j + 1];
    s2 = (Te2[__range(t2, 31, 24)] & 0xff000000) ^
         (Te3[__range(t3, 23, 16)] & 0x00ff0000) ^
         (Te0[__range(t0, 15,  8)] & 0x0000ff00) ^
         (Te1[__range(t1,  7,  0)] & 0x000000ff) ^ ekey[j + 2];
    s3 = (Te2[__range(t3, 31, 24)] & 0xff000000) ^
         (Te3[__range(t0, 23, 16)] & 0x00ff0000) ^
         (Te0[__range(t1, 15,  8)] & 0x0000ff00) ^
         (Te1[__range(t2,  7,  0)] & 0x000000ff) ^ ekey[j + 3];
