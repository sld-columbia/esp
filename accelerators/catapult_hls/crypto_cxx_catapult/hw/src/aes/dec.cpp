...
void aes_decrypt(uint32 key_bytes,
...
AES_DECRYPT_L_1:
    for (i = 0; i < 5; i += 1)
    {
        ...
        t0 = Td0[__range(s0, 31, 24)] ^
             Td1[__range(s3, 23, 16)] ^
             Td2[__range(s2, 15,  8)] ^
             Td3[__range(s1,  7,  0)] ^ ekey[j + 4];
        t1 = Td0[__range(s1, 31, 24)] ^
             Td1[__range(s0, 23, 16)] ^
             Td2[__range(s3, 15,  8)] ^
             Td3[__range(s2,  7,  0)] ^ ekey[j + 5];
        t2 = Td0[__range(s2, 31, 24)] ^
             Td1[__range(s1, 23, 16)] ^
             Td2[__range(s0, 15,  8)] ^
             Td3[__range(s3,  7,  0)] ^ ekey[j + 6];
        t3 = Td0[__range(s3, 31, 24)] ^
             Td1[__range(s2, 23, 16)] ^
             Td2[__range(s1, 15,  8)] ^
             Td3[__range(s0,  7,  0)] ^ ekey[j + 7];

        s0 = Td0[__range(t0, 31, 24)] ^
             Td1[__range(t3, 23, 16)] ^
             Td2[__range(t2, 15,  8)] ^
             Td3[__range(t1,  7,  0)] ^ ekey[j + 8];
        s1 = Td0[__range(t1, 31, 24)] ^
             Td1[__range(t0, 23, 16)] ^
             Td2[__range(t3, 15,  8)] ^
             Td3[__range(t2,  7,  0)] ^ ekey[j + 9];
        s2 = Td0[__range(t2, 31, 24)] ^
             Td1[__range(t1, 23, 16)] ^
             Td2[__range(t0, 15,  8)] ^
             Td3[__range(t3,  7,  0)] ^ ekey[j + 10];
        s3 = Td0[__range(t3, 31, 24)] ^
             Td1[__range(t2, 23, 16)] ^
             Td2[__range(t1, 15,  8)] ^
    ...
    s0 = (Td4[__range(t0, 31, 24)] << 24) ^
         (Td4[__range(t3, 23, 16)] << 16) ^
         (Td4[__range(t2, 15,  8)] <<  8) ^
         (Td4[__range(t1,  7,  0)] <<  0) ^ ekey[j +0];
    s1 = (Td4[__range(t1, 31, 24)] << 24) ^
         (Td4[__range(t0, 23, 16)] << 16) ^
         (Td4[__range(t3, 15,  8)] <<  8) ^
         (Td4[__range(t2,  7,  0)] <<  0) ^ ekey[j +1];
    s2 = (Td4[__range(t2, 31, 24)] << 24) ^
         (Td4[__range(t1, 23, 16)] << 16) ^
         (Td4[__range(t0, 15,  8)] <<  8) ^
         (Td4[__range(t3,  7,  0)] <<  0) ^ ekey[j +2];
    s3 = (Td4[__range(t3, 31, 24)] << 24) ^
         (Td4[__range(t2, 23, 16)] << 16) ^
         (Td4[__range(t1, 15,  8)] <<  8) ^
         (Td4[__range(t0,  7,  0)] <<  0) ^ ekey[j +3];
