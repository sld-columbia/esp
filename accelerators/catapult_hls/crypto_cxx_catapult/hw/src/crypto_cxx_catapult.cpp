...
void CCS_BLOCK(crypto_cxx_catapult)(
    ...
    ESP_REPORT_INFO(VOFF, "conf_info.in_bytes = %u", ESP_TO_UINT32(sha1_in_bytes));
...
LOAD_LOOP:
    ...
    compute_wrapper<sha1_plm_in_t, sha1_plm_out_t>(sha1_in_bytes, sha1_plm_in, sha1_plm_out);
