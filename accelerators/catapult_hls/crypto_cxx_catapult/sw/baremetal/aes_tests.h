...
#if !(defined(AES_ECB_OPERATION_MODE) || defined(AES_CTR_OPERATION_MODE) || \
      defined(AES_CBC_OPERATION_MODE) || defined(AES_GCM_OPERATION_MODE))
    #error "AES mode is not defined!"
    #error \
        "Compilation flags: [-DAES_ECB_OPERATION_MODE=1 | -DAES_CTR_OPERATION_MODE=2 | -DAES_CBC_OPERATION_MODE=3 | -DAES_GCM_OPERATION_MODE=4]"
...
static unsigned aes_ecb_raw_encrypt_key_bytes[N_TESTS] = {4 * 4, 4 * 4, 4 * 4, 4 * 4, 4 * 4,
                                                          4 * 4, 4 * 4, 4 * 4, 4 * 4, 4 * 4};
...
static unsigned aes_ecb_raw_encrypt_plaintext_bytes[N_TESTS] = {
    4 * 4, 8 * 4, 12 * 4, 16 * 4, 20 * 4, 24 * 4, 28 * 4, 32 * 4, 36 * 4, 40 * 4};
static unsigned aes_ecb_raw_encrypt_plaintext_words[N_TESTS] = {4,  8,  12, 16, 20,
                                                                24, 28, 32, 36, 40};
...
static unsigned aes_ecb_raw_encrypt_ciphertext_bytes[N_TESTS] = {
    4 * 4, 8 * 4, 12 * 4, 16 * 4, 20 * 4, 24 * 4, 28 * 4, 32 * 4, 36 * 4, 40 * 4};
static unsigned aes_ecb_raw_encrypt_ciphertext_words[N_TESTS] = {4,  8,  12, 16, 20,
                                                                 24, 28, 32, 36, 40};
#endif
...
static unsigned aes_cbc_raw_encrypt_key_bytes[N_TESTS] = {4 * 4, 4 * 4, 4 * 4, 4 * 4, 4 * 4,
                                                          4 * 4, 4 * 4, 4 * 4, 4 * 4, 4 * 4};
...
static unsigned aes_cbc_raw_encrypt_iv_bytes[N_TESTS] = {4 * 4, 4 * 4, 4 * 4, 4 * 4, 4 * 4,
                                                         4 * 4, 4 * 4, 4 * 4, 4 * 4, 4 * 4};
...
static unsigned aes_cbc_raw_encrypt_plaintext_bytes[N_TESTS] = {
    4 * 4, 8 * 4, 12 * 4, 16 * 4, 20 * 4, 24 * 4, 28 * 4, 32 * 4, 36 * 4, 40 * 4};
static unsigned aes_cbc_raw_encrypt_plaintext_words[N_TESTS] = {4,  8,  12, 16, 20,
                                                                24, 28, 32, 36, 40};
...
static unsigned aes_cbc_raw_encrypt_ciphertext_bytes[N_TESTS] = {
    4 * 4, 8 * 4, 12 * 4, 16 * 4, 20 * 4, 24 * 4, 28 * 4, 32 * 4, 36 * 4, 40 * 4};
static unsigned aes_cbc_raw_encrypt_ciphertext_words[N_TESTS] = {4,  8,  12, 16, 20,
                                                                 24, 28, 32, 36, 40};
#endif

static void aes_init_buf(unsigned idx, token_t *inputs, token_t *gold_outputs,
                         unsigned *raw_encrypt_key_words, unsigned *raw_encrypt_iv_words,
                         unsigned *raw_encrypt_plaintext_words,
                         unsigned *raw_encrypt_ciphertext_words, unsigned raw_encrypt_key[][4],
                         unsigned raw_encrypt_iv[][4], unsigned raw_encrypt_plaintext[][40],
                         unsigned raw_encrypt_ciphertext[][40])
{
    int i, j;
