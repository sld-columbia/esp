...
set ACCELERATOR "sha2_cxx_catapult"
set PLM_WIDTH 32
...
solution file add ../src/sha2.cpp -type C++
solution file add ../inc/sha2.h -type C++
solution file add ../inc/sha2_256.h -type C++
#solution file add ../inc/sha2_512.h -type C++
solution file add ../src/sha2_cxx_catapult.cpp -type C++
solution file add ../inc/sha2_cxx_catapult.hpp -type C++

solution file add ../tb/main.cpp -type C++ -exclude true

solution file set ../src/sha2_cxx_catapult.cpp -args -DDMA_WIDTH=$DMA_WIDTH
solution file set ../inc/sha2_cxx_catapult.hpp -args -DDMA_WIDTH=$DMA_WIDTH
...
if {$opt(hsynth)} {
    ...
    if {$TECH eq "gf12"} {
        ...
        directive set /sha2_cxx_catapult/core/plm_in.data:rsc -MAP_TO_MODULE Xilinx_RAMS.BLOCK_1R1W_RBW
    }
    directive set /sha2_cxx_catapult/core/plm_in.data:rsc -GEN_EXTERNAL_ENABLE true
    ...
    directive set /sha2_cxx_catapult/sha256_block/core/tmp:rsc -MAP_TO_MODULE {[Register]}

    # Loops
    #directive set /sha2_cxx_catapult/sha256_block/core/main -UNROLL no
    #directive set /sha2_cxx_catapult/sha256_block/core/SHA256_BLOCK_L_1 -UNROLL no
    #directive set /sha2_cxx_catapult/sha256_block/core/SHA256_BLOCK_L_2 -UNROLL no
    #directive set /sha2_cxx_catapult/sha256_block/core/SHA256_BLOCK_L_2_1 -UNROLL no
    #directive set /sha2_cxx_catapult/sha256_block/core/SHA256_BLOCK_L_3 -UNROLL no
    #directive set /sha2_cxx_catapult/sha256_block/core/SHA256_BLOCK_L_3_1 -UNROLL no
    #directive set /sha2_cxx_catapult/sha256_block/core/SHA256_BLOCK_L_4 -UNROLL no
