...
set ACCELERATOR "sha1_cxx_catapult"
set PLM_WIDTH 32
...
solution file add ../src/sha1.cpp -type C++
solution file add ../inc/sha1.h -type C++
solution file add ../src/sha1_cxx_catapult.cpp -type C++
solution file add ../inc/sha1_cxx_catapult.hpp -type C++

solution file add ../tb/main.cpp -type C++ -exclude true

solution file set ../src/sha1_cxx_catapult.cpp -args -DDMA_WIDTH=$DMA_WIDTH
solution file set ../inc/sha1_cxx_catapult.hpp -args -DDMA_WIDTH=$DMA_WIDTH
...
if {$opt(hsynth)} {
    ...
    directive set /$ACCELERATOR/core/plm_in.data:rsc -GEN_EXTERNAL_ENABLE true
