...
set ACCELERATOR "rsa_cxx_catapult"
set PLM_WIDTH 32
...
solution file add ../inc/padding.h -type C++
solution file add ../inc/properties.h -type C++
solution file add ../inc/rsa.h -type C++
solution file add ../inc/rsa_cxx_catapult.hpp -type C++

solution file add ../src/rsa.cpp -type C++
solution file add ../src/rsa_cxx_catapult.cpp -type C++

solution file add ../tb/main.cpp -type C++ -exclude true

solution file set ../src/rsa_cxx_catapult.cpp -args -DDMA_WIDTH=$DMA_WIDTH
solution file set ../inc/rsa_cxx_catapult.hpp -args -DDMA_WIDTH=$DMA_WIDTH
...
if {$opt(hsynth)} {
    ...
    directive set /$ACCELERATOR/core/plm_e.data:rsc -MAP_TO_MODULE {[Register]}
    directive set /$ACCELERATOR/core/plm_n.data:rsc -MAP_TO_MODULE {[Register]}
    directive set /$ACCELERATOR/core/plm_r.data:rsc -MAP_TO_MODULE {[Register]}
    ...
    directive set /$ACCELERATOR/core/LOAD_IN_CTRL_LOOP -MERGEABLE false
    directive set /$ACCELERATOR/core/LOAD_IN_LOOP -MERGEABLE false
    directive set /$ACCELERATOR/core/LOAD_E_CTRL_LOOP -MERGEABLE false
    directive set /$ACCELERATOR/core/LOAD_E_LOOP -MERGEABLE false
    directive set /$ACCELERATOR/core/LOAD_N_CTRL_LOOP -MERGEABLE false
    directive set /$ACCELERATOR/core/LOAD_N_LOOP -MERGEABLE false
    directive set /$ACCELERATOR/core/LOAD_R_CTRL_LOOP -MERGEABLE false
    directive set /$ACCELERATOR/core/LOAD_R_LOOP -MERGEABLE false
    directive set /$ACCELERATOR/core/STORE_CTRL_LOOP -MERGEABLE false
    directive set /$ACCELERATOR/core/STORE_LOOP -MERGEABLE false
