...
set ACCELERATOR "aes_cxx_catapult"
set PLM_WIDTH 32
...
solution file add ../inc/aes.h -type C++
solution file add ../inc/aes_cxx_catapult.hpp -type C++
solution file add ../inc/common.h -type C++
solution file add ../inc/conf_info.hpp -type C++
solution file add ../inc/data.hpp -type C++
solution file add ../inc/debug_info.hpp -type C++
#solution file add ../inc/dec.h -type C++
solution file add ../inc/defines.h -type C++
#solution file add ../inc/enc.h -type C++
#solution file add ../inc/exp.h -type C++
solution file add ../inc/properties.h -type C++
solution file add ../inc/properties_utils.h -type C++
#solution file add ../inc/modes/cbc.h -type C++
#solution file add ../inc/modes/ecb.h -type C++
...
#solution file add ../src/modes/cbc.cpp -type C++
#solution file add ../src/modes/ecb.cpp -type C++
#solution file add ../src/modes/gcm.cpp -type C++
...
if {$opt(hsynth)} {
    ...
    # Arrays
    directive set /aes_cxx_catapult/Te2.rom:rsc -MAP_TO_MODULE {[Register]}
    directive set /aes_cxx_catapult/Te3.rom:rsc -MAP_TO_MODULE {[Register]}
    directive set /aes_cxx_catapult/Te0.rom:rsc -MAP_TO_MODULE {[Register]}
    directive set /aes_cxx_catapult/Te1.rom:rsc -MAP_TO_MODULE {[Register]}
    directive set /aes_cxx_catapult/Td0.rom:rsc -MAP_TO_MODULE {[Register]}
    directive set /aes_cxx_catapult/Td1.rom:rsc -MAP_TO_MODULE {[Register]}
    directive set /aes_cxx_catapult/Td2.rom:rsc -MAP_TO_MODULE {[Register]}
    directive set /aes_cxx_catapult/Td3.rom:rsc -MAP_TO_MODULE {[Register]}
    directive set /aes_cxx_catapult/Td4.rom:rsc -MAP_TO_MODULE {[Register]}
    directive set /aes_cxx_catapult/rcon.rom:rsc -MAP_TO_MODULE {[Register]}
    directive set /aes_cxx_catapult/core/plm_key.data:rsc -MAP_TO_MODULE {[Register]}
    directive set /aes_cxx_catapult/core/plm_in.data:rsc -MAP_TO_MODULE {[Register]}
    directive set /aes_cxx_catapult/core/plm_out.data:rsc -MAP_TO_MODULE {[Register]}
    directive set /aes_cxx_catapult/core/aes:ekey:rsc -MAP_TO_MODULE {[Register]}
    directive set /aes_cxx_catapult/core/aes_ecb_ctr_cipher:in_mem:rsc -MAP_TO_MODULE {[Register]}
    directive set /aes_cxx_catapult/core/aes_ecb_ctr_cipher:out_mem:rsc -MAP_TO_MODULE {[Register]}
