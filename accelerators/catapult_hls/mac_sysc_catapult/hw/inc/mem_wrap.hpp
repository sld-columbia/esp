...
template <unsigned int kNumBanks, unsigned int kNumReadPorts, unsigned int kNumWritePorts,
          ...
          typename DataRReq, typename DataRRsp>
class mem_wrap : public sc_module {
  public:
    ...
    ArbitratedScratchpadDP<kNumBanks, kNumReadPorts, kNumWritePorts, kEntriesPerBank, WordType,
                           false, false>
        mem;
...
#pragma hls_unroll yes
            ...
            mem.run(mem_read_addrs, mem_read_req_valid, mem_write_addrs, mem_write_req_valid,
                    mem_write_data, mem_read_ack, mem_write_ack, mem_read_ready, mem_port_read_out,
