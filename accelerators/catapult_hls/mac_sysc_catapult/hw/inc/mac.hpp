...
SC_MODULE(mac_sysc_catapult)
{
  public:
    ...
    mem_wrap<inbks, inrp, inwp, inebks, DATA_TYPE, NVUINTW(in_as), plm_WR<in_as, inwp>,
             plm_RRq<in_as, inrp>, plm_RRs<inrp>>
        CCS_INIT_S1(plm_in_ping);
    mem_wrap<inbks, inrp, inwp, inebks, DATA_TYPE, NVUINTW(in_as), plm_WR<in_as, inwp>,
             plm_RRq<in_as, inrp>, plm_RRs<inrp>>
        CCS_INIT_S1(plm_in_pong);
    mem_wrap<outbks, outrp, outwp, outebks, DATA_TYPE, NVUINTW(out_as), plm_WR<out_as, outwp>,
             plm_RRq<out_as, outrp>, plm_RRs<outrp>>
        CCS_INIT_S1(plm_out_ping);
    mem_wrap<outbks, outrp, outwp, outebks, DATA_TYPE, NVUINTW(out_as), plm_WR<out_as, outwp>,
             plm_RRq<out_as, outrp>, plm_RRs<outrp>>
        CCS_INIT_S1(plm_out_pong);
