...
public:
  ...
  sc_out<sc_logic> conf_info_out_val;
  sc_in<sc_logic> conf_info_out_rdy;
  sc_out<sc_lv<96> > conf_info_out_msg;
  sc_out<sc_logic> sync00_val;
  sc_in<sc_logic> sync00_rdy;
  sc_out<sc_logic> sync00_msg;
  sc_in<sc_logic> in_wr_req_val;
  sc_out<sc_logic> in_wr_req_rdy;
  sc_in<sc_lv<32> > in_wr_req_msg;
  sc_out<sc_logic> in_rd_rsp_val;
  sc_in<sc_logic> in_rd_rsp_rdy;
  sc_out<sc_lv<64> > in_rd_rsp_msg;
public:
  ccs_DUT_wrapper(const sc_module_name& nm, const char *hdl_name)
  :
