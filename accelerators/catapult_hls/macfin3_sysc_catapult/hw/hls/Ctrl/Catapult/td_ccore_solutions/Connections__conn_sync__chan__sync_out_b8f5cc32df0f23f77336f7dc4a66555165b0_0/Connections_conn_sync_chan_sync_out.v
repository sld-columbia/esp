...
module esp_acc_DUMMY_Connections_conn_sync_chan_sync_out_core (
  ...
  assign nl_ccs_ccore_done_synci_ivld = io_read_ccs_ccore_start_rsc_sft_lpi_1_dfm_1
      & this_rdy;
  esp_acc_DUMMY_ccs_in_v1 #(.rscid(32'sd101),
  .width(32'sd1)) ccs_ccore_start_rsci (
      .dat(ccs_ccore_start_rsc_dat),
      .idat(ccs_ccore_start_rsci_idat)
    );
  esp_acc_DUMMY_ccs_sync_out_vld_v1 #(.rscid(32'sd103)) ccs_ccore_done_synci (
...
module Connections_conn_sync_chan_sync_out (
  this_vld, this_rdy, ccs_ccore_start_rsc_dat, ccs_ccore_done_sync_vld, ccs_MIO_clk,
      ccs_MIO_arst
);
  output this_vld;
  ...
  // Interconnect Declarations for Component Instantiations 
  esp_acc_DUMMY_Connections_conn_sync_chan_sync_out_core Connections_conn_sync_chan_sync_out_core_inst
      (
      .this_vld(this_vld),
      .this_rdy(this_rdy),
