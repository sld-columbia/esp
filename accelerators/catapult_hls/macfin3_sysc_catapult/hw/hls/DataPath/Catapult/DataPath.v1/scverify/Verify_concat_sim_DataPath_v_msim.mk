# ----------------------------------------------------------------------------
# Concat concat_sim_DataPath Verilog
#
...
export STAGE
ifeq "$(NETLIST_LEAF)" ""
NETLIST_LEAF           = concat_sim_DataPath
endif
export NETLIST_LEAF
ifeq "$(SIMTOOL)" ""
SIMTOOL                = msim
...
ifeq ($(GATE_VLOG_DEP),)
GATE_VLOG_DEP = ./concat_sim_DataPath.v/concat_sim_DataPath.v.vts
endif
endif
VHDL_SRC +=  $(GATE_VHDL_DEP) 
VLOG_SRC +=  $(GATE_VLOG_DEP) ./scverify/ccs_wrapper_DataPath.v/ccs_wrapper_DataPath.v.vts
else
VHDL_SRC += 
VLOG_SRC += ./concat_sim_DataPath.v/concat_sim_DataPath.v.vts ./scverify/ccs_wrapper_DataPath.v/ccs_wrapper_DataPath.v.vts
endif
...
$(TARGET)/concat_sim_DataPath.v.vts: ./concat_sim_DataPath.v
...
$(TARGET)/concat_sim_DataPath.v.vts: HDL_LIB=work
ifeq ($(STAGE),gate)
ifneq ($(GATE_VHDL_DEP),)
...
$(TARGET)/concat_sim_DataPath.v.vts: VLOG_F_OPTS=
$(TARGET)/ccs_wrapper_DataPath.v.vts: NCVLOG_F_OPTS=
$(TARGET)/concat_sim_DataPath.v.vts: NCVLOG_F_OPTS=
$(TARGET)/ccs_wrapper_DataPath.v.vts: VCS_F_OPTS=
$(TARGET)/concat_sim_DataPath.v.vts: VCS_F_OPTS=
# 
# Specify top design unit for HDL source
$(TARGET)/ccs_wrapper_DataPath.v.vts: DUT_E=ccs_wrapper
$(TARGET)/concat_sim_DataPath.v.vts: DUT_E=DataPath
