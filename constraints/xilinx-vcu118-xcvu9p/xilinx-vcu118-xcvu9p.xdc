...
set_input_jitter [get_clocks -of_objects [get_ports c0_sys_clk_p]] 0.050
...
set_clock_groups -asynchronous -group [get_clocks [get_clocks -of_objects [get_nets chip_clkm]]] -group [get_clocks [get_clocks -of_objects [get_nets chip_clk]]]
...
set_property IOSTANDARD LVCMOS18 [get_ports uart_*]
set_input_delay -clock [get_clocks [get_clocks -of_objects [get_nets chip_clk]]] -max 1.500 [get_ports uart_rxd]
set_input_delay -clock [get_clocks [get_clocks -of_objects [get_nets chip_clk]]] -min -add_delay 0.500 [get_ports uart_rxd]
set_input_delay -clock [get_clocks [get_clocks -of_objects [get_nets chip_clk]]] -max 1.500 [get_ports uart_ctsn]
set_input_delay -clock [get_clocks [get_clocks -of_objects [get_nets chip_clk]]] -min -add_delay 0.500 [get_ports uart_ctsn]
set_output_delay -clock [get_clocks [get_clocks -of_objects [get_nets chip_clk]]] -max 0.500 [get_ports uart_txd]
set_output_delay -clock [get_clocks [get_clocks -of_objects [get_nets chip_clk]]] -min -add_delay -0.500 [get_ports uart_txd]
set_output_delay -clock [get_clocks [get_clocks -of_objects [get_nets chip_clk]]] -max 0.500 [get_ports uart_rtsn]
set_output_delay -clock [get_clocks [get_clocks -of_objects [get_nets chip_clk]]] -min -add_delay -0.500 [get_ports uart_rtsn]
set_property IOSTANDARD LVCMOS12 [get_ports led*]
set_property IOSTANDARD LVCMOS18 [get_ports button*]
set_property IOSTANDARD LVCMOS12 [get_ports switch*]

####################################################################################
# Constraints from file : 'xilinx-vcu118-xcvu9p-eth-pins.xdc'
####################################################################################
