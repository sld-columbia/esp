...
set_clock_groups -asynchronous -group [get_clocks erx_clk] -group [get_clocks [get_clocks -of_objects [get_ports clk_emu_p]]]

set_clock_groups -asynchronous -group [get_clocks etx_clk] -group [get_clocks [get_clocks -of_objects [get_ports clk_emu_p]]]
