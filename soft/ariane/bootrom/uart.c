...
uint32_t read_reg_u32(uintptr_t addr) { return *(volatile uint32_t *)addr; }

int is_transmit_empty() { return read_reg_u32(UART_STATUS) & UART_STATUS_TE; }
...
void init_uart()
{
    ...
    print_uart("ESP-Ariane boot loader\n\n");
}
