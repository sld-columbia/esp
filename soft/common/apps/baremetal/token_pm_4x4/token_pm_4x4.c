...
//Test running all tiles
   ...
   unsigned done_c1=0, done_c2=0, done_c1_before=0, done_c2_before=0;
   ...
   conv2d_token_t *mem_c1, *mem_c2;
   conv2d_token_t *gold_conv2d;
   unsigned errors = 0;
   unsigned coherence = ACC_COH_RECALL;
   const int ERROR_COUNT_TH = 0.001;
   uint64_t cycles_start = 0, cycles_end_n1 = 0,cycles_end_n2 = 0, cycles_end_n3 = 0, cycles_end_n4 = 0, cycles_end_n5 = 0, cycles_end_n6 = 0, cycles_end_g1 = 0, cycles_end_g2 = 0, cycles_end_g3 = 0, cycles_end_g4 = 0, cycles_end_c1 = 0, cycles_end_c2 = 0 ;
       int ndev;
   ...
   reset_token_pm(espdevs);
	   ...
	   write_lut(espdevs, lut_data_const_vc707_GEMM, random_rate_const_0, no_activity_const,1);    
	   write_lut(espdevs, lut_data_const_vc707_GEMM, random_rate_const_0, no_activity_const,2);    
	   write_lut(espdevs, lut_data_const_vc707_GEMM, random_rate_const_0, no_activity_const,3);    
	   ...
	   write_lut(espdevs, lut_data_const_vc707_NV, random_rate_const, no_activity_const,8);    
	   write_lut(espdevs, lut_data_const_vc707_NV, random_rate_const, no_activity_const,9);    
	   write_lut(espdevs, lut_data_const_vc707_CONV2D, random_rate_const, no_activity_const,10);    
	   write_lut(espdevs, lut_data_const_vc707_CONV2D, random_rate_const, no_activity_const,11);    
   #endif
   ...
   */
   ...
   setup_conv2d(dev_c2, mem_c2, ptable_c2, mem_size);
    ...
    while (!(done_g1 && done_g2 && done_g3 && done_g4 && done_n1 && done_n2 && done_n3 && done_n4 && done_n5 && done_n6&& done_c1 && done_c2)) {
		if(!done_g1) {
	...
	printf("  Conv2D Execution cycles : c1=%llu, c2=%llu\n", cycles_end_c1 - cycles_start, cycles_end_c2 - cycles_start);
