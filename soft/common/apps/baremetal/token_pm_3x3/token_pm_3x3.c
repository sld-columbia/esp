...
//Test running all viterbi and FFT tiles
   struct esp_device *espdevs_fft, *espdevs_viterbi;
   struct esp_device *dev, *dev_f1, *dev_f2, *dev_f3 ;
   struct esp_device *dev_v1, *dev_v2, *dev_v3 ;
   ...
   unsigned done_f3=0, done_v3=0, done_f3_before=0, done_v3_before=0;
   unsigned **ptable = NULL;
   ...
   unsigned **ptable_v3 = NULL;
   vit_token_t *mem_v1, *mem_v2, *mem_v3;
   ...
   unsigned coherence = ACC_COH_RECALL;
   const int ERROR_COUNT_TH = 0.001;
   uint64_t cycles_start = 0, cycles_end_f1 = 0,cycles_end_v1 = 0, cycles_end_f2 = 0, cycles_end_v2 = 0, cycles_end_f3 = 0, cycles_end_v3 = 0 ;
       int ndev;
   ...
   */
   ...
   //////Viterbi setup//////
    ...
    #endif
    dev_v3 = &espdevs_viterbi[2];
    //dev_v3.addr = ACC_ADDR_VITERBI3;
    setup_viterbi(dev_v3, gold_vit, mem_v3, ptable_v3);
    #ifdef DEBUG
    	printf("Viterbi3 setup complete, address=0x%x\n",dev_v3->addr);
    #endif
    ...
    iowrite32(dev_f2, CMD_REG, CMD_MASK_START);
    	...
    	printf("Started F2\n");
    #endif
    iowrite32(dev_v3, CMD_REG, CMD_MASK_START);
    #ifdef DEBUG
    	printf("Started V3\n");
    #endif
    ...
    while (!(done_f1 && done_f2 && done_f3 && done_v1 && done_v2 && done_v3)) {
		if(!done_v1) {
		...
		if(!done_v3) {
        		done_v3 = ioread32(dev_v3, STATUS_REG);
			done_v3 &= STATUS_MASK_DONE;
		}
		if(!done_f3) {
		...
		if(done_v3 && !done_v3_before) {
			cycles_end_v3 = get_counter();
			espdev = &espdevs[4];
			write_config1(espdev, 0, random_rate_const, 0, 0);
			done_v3_before=done_v3;
		}
	...
	printf("  Done\n");
	printf("  Viterbi Execution cycles : v1=%llu, v2=%llu, v3=%llu\n", cycles_end_v1 - cycles_start,cycles_end_v2 - cycles_start,cycles_end_v3 - cycles_start);
