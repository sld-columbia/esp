...
const unsigned Fmax[N_ACC]={lut_data_const_GEMM[max_tokens_GEMM],lut_data_const_GEMM[max_tokens_GEMM],lut_data_const_GEMM[max_tokens_GEMM],lut_data_const_GEMM[max_tokens_GEMM],lut_data_const_NV[max_tokens_NV],lut_data_const_NV[max_tokens_NV],lut_data_const_NV[max_tokens_NV],lut_data_const_NV[max_tokens_NV],lut_data_const_CONV2D[max_tokens_CONV2D],lut_data_const_CONV2D[max_tokens_CONV2D],lut_data_const_CONV2D[max_tokens_CONV2D],lut_data_const_NV[max_tokens_NV],lut_data_const_NV[max_tokens_NV]};
const unsigned Fmin[N_ACC] = {lut_data_const_GEMM[1],lut_data_const_GEMM[1],lut_data_const_GEMM[1],lut_data_const_GEMM[1],lut_data_const_NV[1],lut_data_const_NV[1],lut_data_const_NV[1],lut_data_const_NV[1],lut_data_const_CONV2D[1],lut_data_const_CONV2D[1],lut_data_const_CONV2D[1],lut_data_const_NV[1],lut_data_const_NV[1]};
