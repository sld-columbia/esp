...
static void EdgeBert_FFN_MM2 (struct esp_device *dev, struct esp_device *plic_dev, token_t *mem)

{
   ...
   memset(input_1, -18, N0*M_mat*sizeof(token_t));
   memset(input_2, -12, M_mat*N1*sizeof(token_t));
   
   
  
 
   EdgeBert_MatMul (dev, plic_dev, N0, N1, M_mat, is_relu, mem, Mask_mat, input1, input2, softmax);
...
int main(int argc, char * argv[])
{
    ...
    attention_heads = aligned_malloc(128*768);
            ...
            EdgeBert_FFN_MM2 (&dev, &plic_dev, mem);
