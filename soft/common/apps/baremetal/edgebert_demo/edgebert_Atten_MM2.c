...
static void EdgeBert_Attension_MM2 (struct esp_device *dev, struct esp_device *plic_dev, token_t *mem)

{
   ...
   memset(query_mat_1, 115, 2*N0*N1*sizeof(token_t));
   memset(key_mat_1, 115, 2*N0*N1*sizeof(token_t));
...
int main(int argc, char * argv[])
{
    ...
    attention_heads = aligned_malloc(128*768);
            ...
            EdgeBert_Attension_MM2 (&dev, &plic_dev, mem);
