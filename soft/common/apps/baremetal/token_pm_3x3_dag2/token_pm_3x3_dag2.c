...
int main(int argc, char * argv[])
{
	...
	*cpu_dco_ptr = 0x5000D;
	...
	while (!(done_fft2 && done_fft1 && done_viterbi0 && done_fft0 && done_viterbi1 && done_nvdla0)) {
		...
		if ((done_fft1 && !done_fft1_before) || (done_fft2 && !done_fft2_before)) {
		...
		if ((done_fft1 && !done_fft1_before) || (done_viterbi1 && !done_viterbi1_before)) {
