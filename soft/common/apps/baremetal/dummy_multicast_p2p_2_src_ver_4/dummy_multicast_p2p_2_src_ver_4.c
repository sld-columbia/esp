...
#define NUM_MULTICAST_0 4
#define NUM_MULTICAST_1 11
...
//	}
    ...
    // Indexes
    int dev_id_0[NUM_MULTICAST_0 + 1] = {1, 11, 12, 15, 16};
    int dev_id_1[NUM_MULTICAST_1 + 1] = {0, 2, 3, 4, 5, 6, 7, 8, 9, 10, 13, 14};
