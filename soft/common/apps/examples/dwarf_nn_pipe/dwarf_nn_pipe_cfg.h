...
struct conv2d_stratus_access conv2d_cfg_000[N_CONV_LAYERS] = {
	{
		/* <<--descriptor-->> */
	...
	},
	{
		...
		.esp.p2p_store = {0,0},
		.esp.p2p_nsrcs = {0,1},
		.esp.p2p_srcs = {{"", "", "", ""},{"conv2d_stratus.2", "", "", ""}},
	}
};


struct gemm_stratus_access gemm_cfg_000[N_FC_LAYERS] = {
        {
                /* <<--descriptor-->> */
                .do_relu = DO_RELU,
                .transpose = TRANSPOSE,
...
esp_thread_info_t cfg_000[N_LAYERS] = {
	{
		.run = true,
	...
	{
		.run = true,
		.devname = "conv2d_stratus.2",
		.ioctl_req = CONV2D_STRATUS_IOC_ACCESS,
		.esp_desc = &(conv2d_cfg_000[2].esp),
	},
	{
		.run = true,
		.devname = "conv2d_stratus.3",
		.ioctl_req = CONV2D_STRATUS_IOC_ACCESS,
...
esp_thread_info_t* cfg[N_LAYERS] = {&cfg_000[0],
				    &cfg_000[1],
				    &cfg_000[2],
				    &cfg_000[3],
				    &cfg_000[4],
