...
################################################################
# This is a generated script based on design: zynqmpsoc
#
...
proc create_root_design { parentCell } {
  ...
  set AHB_INTERFACE_0 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:ahblite_rtl:2.0 AHB_INTERFACE_0 ]

  set M_AHB_0 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:ahblite_rtl:2.0 M_AHB_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU__CRL_APB__PL0_REF_CTRL__ACT_FREQMHZ {75.000000} \
  ...
  connect_bd_intf_net -intf_net AHB_INTERFACE_0_1 [get_bd_intf_ports AHB_INTERFACE_0] [get_bd_intf_pins ahblite_axi_bridge_0/AHB_INTERFACE]
connect_bd_intf_net -intf_net [get_bd_intf_nets AHB_INTERFACE_0_1] [get_bd_intf_ports AHB_INTERFACE_0] [get_bd_intf_pins system_ila_0/SLOT_1_AHBLITE]
  connect_bd_intf_net -intf_net ahblite_axi_bridge_0_M_AXI [get_bd_intf_pins ahblite_axi_bridge_0/M_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HPC0_FPD]
  connect_bd_intf_net -intf_net axi_ahblite_bridge_0_M_AHB [get_bd_intf_ports M_AHB_0] [get_bd_intf_pins axi_ahblite_bridge_0/M_AHB]
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_ahblite_bridge_0_M_AHB] [get_bd_intf_ports M_AHB_0] [get_bd_intf_pins system_ila_0/SLOT_0_AHBLITE]
  ...
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_FPD [get_bd_intf_pins axi_ahblite_bridge_0/AXI4] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD]
  ...
  connect_bd_net -net rst_ps8_0_75M_peripheral_aresetn [get_bd_pins ahblite_axi_bridge_0/s_ahb_hresetn] [get_bd_pins axi_ahblite_bridge_0/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_75M/peripheral_aresetn]
  connect_bd_net -net rst_ps8_0_75M_peripheral_reset [get_bd_ports peripheral_reset_0] [get_bd_pins rst_ps8_0_75M/peripheral_reset]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_ports pl_clk0] [get_bd_pins ahblite_axi_bridge_0/s_ahb_hclk] [get_bd_pins axi_ahblite_bridge_0/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_75M/slowest_sync_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins rst_ps8_0_75M/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]

  # Create address segments
  assign_bd_address -offset 0x000400000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs M_AHB_0/Reg] -force
  ...
  assign_bd_address -offset 0x40000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces AHB_INTERFACE_0] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_DDR_LOW] -force

  # Exclude Address Segments
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces AHB_INTERFACE_0] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_DDR_HIGH]
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces AHB_INTERFACE_0] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_LPS_OCM]
  exclude_bd_addr_seg -offset 0xE0000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces AHB_INTERFACE_0] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_PCIE_LOW]
  exclude_bd_addr_seg -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces AHB_INTERFACE_0] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_QSPI]
