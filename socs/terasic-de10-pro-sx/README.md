...
that adapter describes an Intel HPS interface rather than this specific board.
Its ports are flat rather than GRLIB records because `ghrd_s10_top.v` is
Verilog and VHDL record types cannot cross that instantiation boundary.
