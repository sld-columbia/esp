...
architecture rtl of cva6_axi_wrap is

  component cva6_wrap is
    generic (
      NMST             : integer;
      NSLV             : integer;
  ...
  constant CVA6_AXI_ID_WIDTH : integer := 4;
  constant CVA6_AXI_ID_WIDTH_SLV : integer := CVA6_AXI_ID_WIDTH + log2(NMST);

begin  -- architecture rtl

  cva6_wrap_1 : cva6_wrap
    generic map (
      NMST             => NMST,
      NSLV             => NSLV,
      AXI_ID_WIDTH     => CVA6_AXI_ID_WIDTH,
      AXI_ID_WIDTH_SLV => CVA6_AXI_ID_WIDTH_SLV,
    ...
    port map (
      ...
      timer_irq       => timer_irq,
      ipi             => ipi,
      rom_aw_id       => romi.aw.id(CVA6_AXI_ID_WIDTH_SLV - 1 downto 0),
      ...
      rom_b_id        => romo.b.id(CVA6_AXI_ID_WIDTH_SLV - 1 downto 0),
      rom_b_resp      => romo.b.resp,
      rom_b_user      => romo.b.user,
      rom_b_valid     => romo.b.valid,
      rom_b_ready     => romi.b.ready,
      rom_ar_id       => romi.ar.id(CVA6_AXI_ID_WIDTH_SLV - 1 downto 0),
      ...
      rom_r_id        => romo.r.id(CVA6_AXI_ID_WIDTH_SLV - 1 downto 0),
      ...
      dram_aw_id      => drami.aw.id(CVA6_AXI_ID_WIDTH_SLV - 1 downto 0),
      ...
      dram_b_id       => dramo.b.id(CVA6_AXI_ID_WIDTH_SLV - 1 downto 0),
      dram_b_resp     => dramo.b.resp,
      dram_b_user     => dramo.b.user,
      dram_b_valid    => dramo.b.valid,
      dram_b_ready    => drami.b.ready,
      dram_ar_id      => drami.ar.id(CVA6_AXI_ID_WIDTH_SLV - 1 downto 0),
      ...
      dram_r_id       => dramo.r.id(CVA6_AXI_ID_WIDTH_SLV - 1 downto 0),
      ...
      clint_aw_id     => clinti.aw.id(CVA6_AXI_ID_WIDTH_SLV - 1 downto 0),
      ...
      clint_b_id      => clinto.b.id(CVA6_AXI_ID_WIDTH_SLV - 1 downto 0),
      clint_b_resp    => clinto.b.resp,
      clint_b_user    => clinto.b.user,
      clint_b_valid   => clinto.b.valid,
      clint_b_ready   => clinti.b.ready,
      clint_ar_id     => clinti.ar.id(CVA6_AXI_ID_WIDTH_SLV - 1 downto 0),
      ...
      clint_r_id      => clinto.r.id(CVA6_AXI_ID_WIDTH_SLV - 1 downto 0),
      ...
      slm_aw_id       => slmi.aw.id(CVA6_AXI_ID_WIDTH_SLV - 1 downto 0),
      ...
      slm_b_id        => slmo.b.id(CVA6_AXI_ID_WIDTH_SLV - 1 downto 0),
      slm_b_resp      => slmo.b.resp,
      slm_b_user      => slmo.b.user,
      slm_b_valid     => slmo.b.valid,
      slm_b_ready     => slmi.b.ready,
      slm_ar_id       => slmi.ar.id(CVA6_AXI_ID_WIDTH_SLV - 1 downto 0),
      ...
      slm_r_id        => slmo.r.id(CVA6_AXI_ID_WIDTH_SLV - 1 downto 0),
      ...
      slmddr_aw_id     => slmddri.aw.id(CVA6_AXI_ID_WIDTH_SLV - 1 downto 0),
      ...
      slmddr_b_id      => slmddro.b.id(CVA6_AXI_ID_WIDTH_SLV - 1 downto 0),
      slmddr_b_resp    => slmddro.b.resp,
      slmddr_b_user    => slmddro.b.user,
      slmddr_b_valid   => slmddro.b.valid,
      slmddr_b_ready   => slmddri.b.ready,
      slmddr_ar_id     => slmddri.ar.id(CVA6_AXI_ID_WIDTH_SLV - 1 downto 0),
      ...
      slmddr_r_id      => slmddro.r.id(CVA6_AXI_ID_WIDTH_SLV - 1 downto 0),
  ...
  romi.aw.id(XID_WIDTH - 1 downto CVA6_AXI_ID_WIDTH_SLV)  <= (others => '0');
  romi.ar.id(XID_WIDTH - 1 downto CVA6_AXI_ID_WIDTH_SLV)  <= (others => '0');
  drami.aw.id(XID_WIDTH - 1 downto CVA6_AXI_ID_WIDTH_SLV) <= (others => '0');
  drami.ar.id(XID_WIDTH - 1 downto CVA6_AXI_ID_WIDTH_SLV) <= (others => '0');
  clinti.aw.id(XID_WIDTH - 1 downto CVA6_AXI_ID_WIDTH_SLV)  <= (others => '0');
  clinti.ar.id(XID_WIDTH - 1 downto CVA6_AXI_ID_WIDTH_SLV)  <= (others => '0');
  slmi.aw.id(XID_WIDTH - 1 downto CVA6_AXI_ID_WIDTH_SLV)  <= (others => '0');
  slmi.ar.id(XID_WIDTH - 1 downto CVA6_AXI_ID_WIDTH_SLV)  <= (others => '0');
  slmddri.aw.id(XID_WIDTH - 1 downto CVA6_AXI_ID_WIDTH_SLV)  <= (others => '0');
  slmddri.ar.id(XID_WIDTH - 1 downto CVA6_AXI_ID_WIDTH_SLV)  <= (others => '0');
